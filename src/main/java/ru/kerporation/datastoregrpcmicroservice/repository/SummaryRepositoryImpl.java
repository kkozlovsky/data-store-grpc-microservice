...
import ru.kerporation.datastoregrpcmicroservice.config.RedisSchema;
import ru.kerporation.datastoregrpcmicroservice.model.*;
...
public class SummaryRepositoryImpl implements SummaryRepository {
    ...
    private Optional<Summary> getSummary(final long sensorId,
        ...
        for (final MeasurementType mType : measurementTypes) {
            for (final SummaryType sType : summaryTypes) {
